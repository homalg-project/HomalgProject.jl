...
40 primitive operations were used to derive 266 operations for this category which
* IsAbCategory
* IsMonoidalCategory
...
21 primitive operations were used to derive 217 operations for this category which
* IsAbCategory
* IsAbelianCategory
